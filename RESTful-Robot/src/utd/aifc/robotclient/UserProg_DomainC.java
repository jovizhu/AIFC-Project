...
public class UserProg_DomainC {
	...
	public static void main(String[] args) {
		...
		//////////////////////////////////////////////////////
				...
				String pass = "person1";
				String role="SE_Director";
				String domainName="DomainC";
...
/////////////////////////////////////////////////////////////
		...
		///////////////////////////////////////////////////
			...
			//String cred = CAValidator.loginCA("Person1", "person1", "DomainC");
			...
			s.create_robot("rbt_New", "DomainC", "RobotTable","Person1","DomainC", creds[3],contributorlist,credential);
			...
			s.read_robot("rbt_New", "DomainB", "Person1", creds[3],creds[4], credential);
			long etime19 = System.currentTimeMillis();
			System.out.println("Start Time = " + stime19 +" End Time = " + etime19 +" Total Time= " + (etime19 - stime19) +"\n");

		   // s.read_robot("Walls", "DomainC", "Person1", creds[2],creds[3], cred);
			...
			//s.create_robot("Test100", "DomainC", "RobotTable", "Person1", creds[3], creds[2], contributors, cred);
